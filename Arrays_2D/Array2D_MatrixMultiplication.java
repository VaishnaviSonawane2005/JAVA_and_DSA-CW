...
public class Array2D_MatrixMultiplication {
    ...
    public static void main(String[] args) {
        ...
        int c1= sc.nextInt();
        int[][] a=new int[r1][c1];
        System.out.println("Enter the 2 Dimensional Array having "+r1*c1+" elements of Matrix 1:");
        for (int i = 0; i < r1; i++) {
            for (int j = 0; j < c1; j++) {
                a[i][j]= sc.nextInt();
            }
        ...
        int c2= sc.nextInt();
        int[][] b=new int[r2][c2];
        System.out.println("Enter the 2 Dimensional Array having "+r2*c2+" elements of Matrix 2:");
        for (int i = 0; i < r2; i++) {
            for (int j = 0; j < c2; j++) {
                b[i][j]= sc.nextInt();
            }
